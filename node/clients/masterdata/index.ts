...
export class MasterData extends ExternalClient {
  ...
  public uploadAttachment = (
    ...
    this.post<any>(this.routes.saveAttachment(acronym, id, fields), formData, {
      headers: formData.getHeaders(),
      metric: 'masterdata-uploadAttachment',
    })

  public downloadAttachment = (acronym: string, id: string, fields: string) =>
    this.get<any>(this.routes.retrieveAttachment(acronym, id, fields, id), {
      metric: 'masterdata-downloadAttachment',
    })
  ...
  private get routes() {
    return {
      saveAttachment: (acronym: string, id: string, fields: string) => {
      ...
      retrieveAttachment: (
        ...
        return `${DATAENTITIES_PREFIX}/${acronym}/documents/${id}/${fields}/attachments/${fileName}.json`
      },
